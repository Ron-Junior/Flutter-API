...
class PushNotificationIOS extends Component
{
    ...
    function __construct($sandboxMode = false)
    {
        ...
        $this->apiEndPoint = $this->sandboxMode == true ? 'ssl://gateway.sandbox.push.apple.com:2195' : 'ssl://gateway.push.apple.com:2195';
    }
    ...
    public function send()
    {
        ...
        if ($validate) {
            ...
            $sock = stream_socket_client($this->apiEndPoint, $err, $errstr, 60, STREAM_CLIENT_CONNECT | STREAM_CLIENT_PERSISTENT, $ctx);
